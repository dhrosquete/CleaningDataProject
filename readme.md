...
repository contains the CodeBook in md, pdf and Rmd. 

Script
=========================
The commented script file is called run_analysis.R If you want to use it,
you should change de setwd to your own path and then it will work direct.
